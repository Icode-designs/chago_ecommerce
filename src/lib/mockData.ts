...
export const mockProducts: Product[] = [
  {
    ...
    description:
      "Minimalist Scandinavian lounge chair with natural oak legs and premium wool upholstery. Designed for comfort and visual silence.",
    price: 1295,
  ...
  },
  {
    ...
    description:
      "A delicate blend of white tea, bergamot, and soft musk. Hand-blended in small batches using sustainably sourced ingredients.",
    price: 185,
  ...
  },
  {
    ...
    description:
      "Wireless over-ear headphones with active noise cancellation and spatial audio. 40-hour battery life.",
    price: 349,
  ...
  },
  {
    ...
    description:
      "Professional-grade mirrorless camera with 61MP full-frame sensor and 8K video recording capability.",
    price: 2499,
  ...
  },
  {
    ...
    slug: "mono-desk-lamp",
    description:
      "Architectural desk lamp with adjustable arm and warm LED illumination. Powder-coated aluminum body.",
    price: 325,
  ...
  },
  {
    ...
    description:
      "Premium smartwatch with titanium case, sapphire crystal display, and 14-day battery life.",
    price: 499,
  ...
  },
  {
    ...
    description:
      "Sculptural coffee table in solid walnut with a hand-polished brass inlay. Each piece is unique.",
    price: 1850,
  ...
  },
  {
    ...
    description:
      "Hand-thrown ceramic oil diffuser with a curated set of three essential oil blends.",
    price: 145,
    compare_at_price: null,
    category_id: "cat-3",
    images: ["/placeholder-product.jpg"],
...
export const mockReviews: Review[] = [
  {
    ...
    rating: 5,
    comment:
      "Absolutely stunning craftsmanship. The chair exceeded my expectations in both comfort and design.",
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Excellent sound quality. The noise cancellation is superb. Slight discomfort after 4+ hours.",
...
export const mockDisputes: Dispute[] = [
  {
    ...
    vendor_id: "vendor-1",
    reason:
      "Product arrived with minor scratch on the leg. Requesting partial refund.",
    status: "in_review",
    resolution: null,
...
export const mockProfiles: Profile[] = [
  ...
  {
    id: "vendor-2",
    email: "contact@luminaelectronics.com",
